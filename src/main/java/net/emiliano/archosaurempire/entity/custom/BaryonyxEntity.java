package net.emiliano.archosaurempire.entity.custom;

import net.emiliano.archosaurempire.entity.ModEntities;
import net.emiliano.archosaurempire.entity.ai.BaryonyxAttackGoal;
...
public class BaryonyxEntity extends Animal {
    private static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(BaryonyxEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new BaryonyxAttackGoal(this, 1.0D, true));

        this.goalSelector.addGoal(1, new BreedGoal(this,1.150));
        this.goalSelector.addGoal(2, new TemptGoal(this,1.20, Ingredient.of(Items.SALMON),  false));
    ...
    public AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        return ModEntities.BARYONYX.get().create(pLevel);
    }
